          ...
          <>
            ...
            >
              {question.options.map(option => (
                <button
                  key={option.id}
                  className="w-full rounded-lg border bg-card p-4 text-left hover:border-primary hover:bg-primary/5 focus:outline-none focus:ring-2 focus:ring-primary transition-all"
