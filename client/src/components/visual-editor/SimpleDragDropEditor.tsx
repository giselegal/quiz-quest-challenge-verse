  ...
  return (
    <div className="h-screen flex bg-background simple-editor">
      ...
      <div className="w-[260px] min-w-[260px] border-r bg-slate-50 overflow-hidden flex flex-col">
        ...
        {/* Coluna 2: Preview */}
        <div className="flex-1 border-l bg-muted/5">
        ...
        <div className="w-80 border-l bg-muted/5">
          <div className="h-full flex flex-col">
            <div className="p-4 border-b">
              <h3 className="text-base font-semibold">🔄 Versionamento</h3>
            ...
            <div className="flex-1 overflow-hidden">
              <ScrollArea className="h-full">
                <div className="p-4 space-y-4">
                  <div className="text-center text-muted-foreground">
                    <p className="text-sm">Controle de versão em desenvolvimento</p>
                  </div>
                </div>
              </ScrollArea>
            </div>
