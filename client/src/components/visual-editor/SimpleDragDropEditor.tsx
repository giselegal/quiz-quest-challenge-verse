    ...
    <div className="h-screen flex bg-background simple-editor">
        ...
        <ScrollArea className="flex-1">
          <div className="p-3 space-y-2">
            ...
            <div className="mt-4">
              ...
              <FunnelSteps setCurrentFunnel={setCurrentFunnel} />
            </div>
          </div>
        </ScrollArea>
      </div>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        <div className="flex-1 p-4 bg-gray-100 overflow-auto">
          <div className="mx-auto bg-white border rounded-lg shadow-lg max-w-lg">
            <div className="p-4">
              <h2 className="text-lg font-semibold mb-4">Preview da Página</h2>
              {currentPage ? (
                <div>
                  <div className="text-sm text-gray-600 mb-2">
                    {currentPage.title} ({currentPage.type})
                  </div>
                  <div className="text-xs text-gray-500">
                    {currentPage.components?.length || 0} componentes
                  </div>
                </div>
              ) : (
      ...
      <div className="w-80 border-l flex flex-col">
        ...
        <div className="p-3 text-center text-gray-500 text-sm">
          Editor de propriedades em desenvolvimento
        </div>
      </div>
    </div>
  );
