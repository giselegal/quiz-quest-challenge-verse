    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: brandColors.background }}>
        <div className="text-center space-y-4">
          <div className="w-16 h-16 border-4 border-gray-200 border-t-4 rounded-full animate-spin mx-auto"
               style={{ borderTopColor: brandColors.primary }}></div>
    ...
    <div className="min-h-screen p-6" style={{ backgroundColor: brandColors.background }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <MetricCard
          ...
          subtitle={`Taxa: ${totalStats.page_views > 0 ? ((totalStats.leads / totalStats.page_views) * 100).toFixed(1) : 0}%`}
          trend={3.1}
      ...
      <div className="mb-6">
        <div className="flex bg-white rounded-lg p-1 shadow-sm border inline-flex">
          ...
          <Button
            ...
            className={selectedView === 'detailed' ? 
              'text-white shadow-sm' : 
              'hover:bg-gray-50'
            }
            style={selectedView === 'detailed' ? {
              backgroundColor: brandColors.primary,
              borderColor: brandColors.primary
            } : {}}
          >
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm" style={{ color: brandColors.text.medium }}>
                <li className="flex items-start space-x-2">
                  ...
                  <span>Criativo "Elegante Mulher Vestido" tem a melhor taxa de conversão (2.3%)</span>
                </li>
                <li className="flex items-start space-x-2">
