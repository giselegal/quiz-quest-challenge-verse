...
const CTAInlineBlock: React.FC<BlockComponentProps> = ({ 
  ...
  const styleClasses = {
    ...
    brand: `bg-gradient-to-r from-[#B89B7A] to-[#a08965] hover:from-[#a08965] hover:to-[#8F7A6A] text-white ${EFFECTS.shadows.brand}`,
    secondary: `bg-gradient-to-r from-[#432818] to-[#2a1910] hover:from-[#2a1910] hover:to-[#1a0f08] text-white`,
