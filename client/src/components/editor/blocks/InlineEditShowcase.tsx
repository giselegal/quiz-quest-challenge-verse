      ...
      <CardContent className="space-y-8">
        ...
        <section>
          ...
          <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
            <InlineEditText
              value={data.title}
              onSave={(value) => updateData('title', value)}
            ...
            <InlineEditText
              value={data.subtitle}
              onSave={(value) => updateData('subtitle', value)}
        ...
        <section>
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            <InlineEditText
              ...
              onSave={(value) => updateData('description', value)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <Badge variant="secondary" className="cursor-pointer">
                <InlineEditText
                  value={data.badge}
                  onSave={(value) => updateData('badge', value)}
                  placeholder="Badge"
                  as="span"
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-2">
                <InlineEditText
                  value={data.label}
                  onSave={(value) => updateData('label', value)}
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex justify-between items-center">
                ...
                <InlineEditText
                  value={data.progress}
                  onSave={(value) => updateData('progress', value)}
                  placeholder="0%"
                  as="span"
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <InlineEditText
                value={data.category}
                onSave={(value) => updateData('category', value)}
